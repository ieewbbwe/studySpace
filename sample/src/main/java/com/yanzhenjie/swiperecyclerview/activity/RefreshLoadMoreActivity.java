...
public class RefreshLoadMoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mSwipeMenuRecyclerView.setItemViewSwipeMySelfEnabled(true);// 开启滑动删除。
        ...
        SimpleItemTouchHelperCallBack callBack = new SimpleItemTouchHelperCallBack(mMenuAdapter, this);
        ItemTouchHelper mItemTouchHelper = new ItemTouchHelper(callBack);
        mItemTouchHelper.attachToRecyclerView(mSwipeMenuRecyclerView);
    }
        ...
        public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
            ...
            // 添加左侧的，如果不添加，则左侧不会出现菜单。
            {
                /*SwipeMenuItem addItem = new SwipeMenuItem(mContext)
                        .setBackgroundDrawable(R.drawable.shape_gradient_red)// 点击的背景。
