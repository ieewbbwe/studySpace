...
import com.yanzhenjie.swiperecyclerview.activity.ItemTouchHelperAdapter;
 ...
 */
public class MenuAdapter extends SwipeMenuAdapter<MenuAdapter.DefaultViewHolder> implements ItemTouchHelperAdapter {
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        Log.d("andy", "onItemMove：" + toPosition);
    }
