...
public class NavigationBar implements View.OnClickListener {
	...
	public void switchToSearch() {
		...
		ObjectAnimator.ofFloat(leftBtn, "alpha", 1.0f, 0.0f)
				.setDuration(duration).start();
		// ObjectAnimator.ofFloat(rightBtn, "alpha",
		// 0.0f,1.0f).setDuration(duration).start();
	...
	public void switchToDefault() {
		...
		ObjectAnimator.ofFloat(leftBtn, "alpha", 0.0f, 1.0f)
				.setDuration(duration).start();
		// ObjectAnimator.ofFloat(rightBtn, "alpha",
		// 1.0f,0.0f).setDuration(duration).start();
	...
	class AnimEndListener implements AnimatorListener {
		private View v;
