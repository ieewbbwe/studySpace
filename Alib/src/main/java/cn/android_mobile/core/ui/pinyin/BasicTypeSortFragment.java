...
public class BasicTypeSortFragment extends BasicFragment {
	...
	protected void initComp() {
		...
		sideBar = (SideBar) v.findViewById(R.id.basic_type_sort_sidrbar);
		dialog = (TextView) v.findViewById(R.id.basic_type_sort_dialog);
		...
		sortListView = (ListView) v.findViewById(R.id.basic_type_sort_listview);
...
//			String sortString = pinyin.substring(0, 1).toUpperCase();
	...
	public void setListener(IBasicTypeSortFragment listener) {
