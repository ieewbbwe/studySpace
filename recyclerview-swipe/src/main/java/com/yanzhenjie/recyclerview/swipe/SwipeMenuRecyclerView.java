...
public class SwipeMenuRecyclerView extends RecyclerView {
    ...
    public void setItemViewSwipeMySelfEnabled(boolean canSwipe) {
        isInterceptTouchEvent = !canSwipe;
    }
        ...
        if (!isInterceptTouchEvent) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    Log.d("andy", "滑动速度:" + velocity + "最小Fill速度:" + mScaledMinimumFlingVelocity + "最大:" + mScaledMaximumFlingVelocity);
            ...
            Log.d("andy", "SwipeRecycleIntercept:" + action + "是否拦截：" + isIntercepted);
        }
    ...
    public boolean onTouchEvent(MotionEvent e) {
        int action = e.getAction();
        Log.d("andy", "SwipeRecycleTouch:" + action);
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                break;
            case MotionEvent.ACTION_MOVE:
