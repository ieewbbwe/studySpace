...
public class BaseRequest extends ServiceRequest {
    ...
    public String cookie = "Y=v=1&n=588s97encs6d9&l=a26x2n6jf6x1x02oslxkjawuib05guai8ispus1a/o&p=m2r0000012000000&iz=&r=10d&lg=zh-Hant-HK&intl=hk&np=1; path=/; domain=.yahoo.com;T=z=aJdDYBaPyDYBqvVG1UlC0U7Nk40NgY2N041NjU1TjU0NDIzNE&a=QAE&sk=DAAkJiq74Zxn6C&ks=EAA_A.SbvVKWsuJ5swFXdyrTQ--~E&kt=EAA0BAOYQeBiSPiETU2GbZlfg--~F&d=; path=/; domain=.yahoo.com; HttpOnly";
    public String wssid = "Mt538HeQ42i";//SharedPrefManager.getWssid("com.yahoo.hkdeals" + CacheConstants.WSSID);
